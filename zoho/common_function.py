...
from zoho.models import ZohoInvoice, ZohoInvoiceItem, ZohoCreditNoteItem
...
class ZohoInvoiceCls:
    ...
    def create_zoho_invoice(cls, validated_rows, created_by):
        try:
            for row in validated_rows:
                zoho_invoice_obj, created = ZohoInvoice.objects.update_or_create(
                    creditnotes_id = row['creditnotes_id'],
                    defaults={'credit_note_date':row['credit_note_date'],
                        'credit_note_number':row['credit_note_number'],
                        'credit_note_status':row['credit_note_status'],
                        'billing_street_2':row['billing_street_2'],
                        'shipping_street_2':row['shipping_street_2'],
                        'shipping_phone':row['shipping_phone'],
                        'reference':row['reference'],
                        'associated_invoice_number':row['associated_invoice_number'],
                        'associated_invoice_date':row['associated_invoice_date'],
                        'applied_invoice_number':row['applied_invoice_number'],
                        'reason':row['reason'],
                        'tax1_id':row['tax1_id'],
                        'customer_id':row['customer_id'],
                        'customer_name':row['customer_name'],
                        'place_of_supply':row['place_of_supply'],
                        'place_of_supply_with_state_code':row['place_of_supply_with_state_code'],
                        'gst_treatment':row['gst_treatment'],
                        'is_inclusive_tax':row['is_inclusive_tax'],
                        'currency_code':row['currency_code'],
                        'exchange_rate':row['exchange_rate'],
                        ...
                        'shipping_charge_tax_amount':row['shipping_charge_tax_amount'],
                        'shipping_charge_tax_name':row['shipping_charge_tax_name'],
                        'shipping_charge_tax_percentage':row['shipping_charge_tax_percentage'],
                        'shipping_charge_tax_type':row['shipping_charge_tax_type'],
                        'shipping_charge_tax_exemption_code':row['shipping_charge_tax_exemption_code'],
                        'shipping_charge_sac_code':row['shipping_charge_sac_code'],
                        'billing_attention':row['billing_attention'],
                        'billing_address':row['billing_address'],
                        'billing_city':row['billing_city'],
                        ...
                        'e_invoice_failure_reason':row['e_invoice_failure_reason'],
                        'supplier_org_name':row['supplier_org_name'],
                        'supplier_gst_registration_number':row['supplier_gst_registration_number'],
                        'supplier_street_address':row['supplier_street_address'],
                        'supplier_city':row['supplier_city'],
                        'supplier_state':row['supplier_state'],
                        'supplier_country':row['supplier_country'],
                        ...
                        'reverse_charge_tax_rate':row['reverse_charge_tax_rate'],
                        'reverse_charge_tax_type':row['reverse_charge_tax_type'],
                        'gst_identification_number_gstin':row['gst_identification_number_gstin'],
                        'nature_of_collection':row['nature_of_collection'],
                        'project_id':row['project_id'],
                        'project_name':row['project_name'],
                        'hsn_sac':row['hsn_sac'],
                ...
                'item_tax_percentage': row['item_tax_percentage'],
                'item_tax_type': row['item_tax_type'],
                'item_tax_exemption_reason': row['item_tax_exemption_reason'],
                'zoho_credit_note': row['zoho_credit_note'],
                'tax1_id': row['tax1_id'],
                    }
                )
