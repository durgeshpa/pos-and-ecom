...
class ZohoCommonFields(models.Model):
    ...
    exchange_rate = models.DecimalField(null=True, blank=True, decimal_places=10)
    ...
    subtotal = models.DecimalField(null=True, blank=True, decimal_places=10)
    total = models.DecimalField(null=True, blank=True, decimal_places=10)
    balance = models.DecimalField(null=True, blank=True, decimal_places=10)
    ...
    e_invoice_ack_date = models.DateField()
    e_invoice_cancel_remark = models.CharField(max_length=100, null=True, blank=True)
    e_invoice_cancel_reason = models.TextField()
    e_invoice_failure_reason = models.TextField()
...
class ZohoCommonItemFields(models.Model):
    ...
    item_price = models.DecimalField(null=True, blank=True, decimal_places=10)
...
class ZohoCreditNote(ZohoCommonFields):
    ...
    associated_invoice_date = models.DateField()
...
class ZohoInvoice(ZohoCommonFields):
    ...
    authorize_net = models.BooleanField()
    google_checkout = models.BooleanField()
    payflow_pro = models.BooleanField()
    stripe = models.BooleanField()
    paytm = models.BooleanField()
    checkout = models.BooleanField()
    braintree = models.BooleanField()
    forte = models.BooleanField()
    worldpay = models.BooleanField()
    payments_pro = models.BooleanField()
    square = models.BooleanField()
    wepay = models.BooleanField()
    razorpay = models.BooleanField()
    gocardless = models.BooleanField()
    partial_payments = models.BooleanField()
...
class ZohoInvoiceItem(ZohoCommonItemFields):
    ...
    item_desc = models.TextField(max_length=100, null=True, blank=True)
    quantity = models.DecimalField(null=True, blank=True, decimal_places=10)
    discount = models.DecimalField(null=True, blank=True, decimal_places=10)
    discount_amount = models.DecimalField(null=True, blank=True, decimal_places=10)
    item_total = models.CharField(max_length=100, null=True, blank=True)
    product_id = models.CharField(max_length=100, null=True, blank=True)
    tax_id = models.CharField(max_length=100, null=True, blank=True)
    item_tax_amount = models.DecimalField(null=True, blank=True, decimal_places=10)
