...
class ProductPrice(models.Model):
    ...
    mrp = models.FloatField(default=0,null=True,blank=False)
    ...
    price_to_service_partner = models.FloatField(default=0,null=True,blank=False)
    price_to_retailer = models.FloatField(default=0,null=True,blank=False)
    price_to_super_retailer = models.FloatField(default=0,null=True,blank=False)
