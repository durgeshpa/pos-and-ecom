...
def products_price_excel(queryset):
    ...
    # column headings
    worksheet.write('A1', 'Product ID', header_format)
    worksheet.write('B1', 'Seller Shop ID', header_format)
    worksheet.write('C1', 'MRP', header_format)
    worksheet.write('D1', 'Selling Price', header_format)
    worksheet.write('E1', 'City', header_format)
    worksheet.write('F1', 'Pincode', header_format)
    worksheet.write('G1', 'Buyer Shop', header_format)
    worksheet.write('H1', 'Price Start Date', header_format)
    worksheet.write('I1', 'Price End Date', header_format)
