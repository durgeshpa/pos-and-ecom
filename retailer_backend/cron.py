...
class DailyStock(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        for shop_obj in Shop.objects.filter(shop_type__shop_type='sp', shop_name__icontains='GFDN'):
            ...
            daily_stock_dt.append(ShopStock(product_id=i['product'], available_qty=i['product_qty_sum'],
                damage_qty=i['damaged_qty_sum'], shop_id=shop_obj.id, created_at=datetime.now()) for i in product_sum)
