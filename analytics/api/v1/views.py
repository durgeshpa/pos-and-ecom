...
class GRNReport(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            order = PurchaseOrder.objects.get(id=request.data.get("order_id"))
            grn_details = {}
            i=0
                ...
                for products in grns.grn_order_grn_order_product.all():
                    ...
                    try:
                        ...
                        GRNReports.objects.using('dataanalytics').create(po_no = po_no, po_date = po_date, po_status = po_status,
                            ...
                            discount = discount,  gram_to_brand_price = gram_to_brand_price, grn_id = grn_id, grn_date = grn_date,
                            grn_sku_pieces = grn_sku_pieces, product_cgst = product_cgst, product_sgst = product_sgst, product_igst = product_igst,
                            product_cess = product_cess, invoice_item_gross_value = invoice_item_gross_value,
                            delivered_sku_pieces = delivered_sku_pieces, returned_sku_pieces = returned_sku_pieces, dn_number = dn_number,
...
class OrderReport(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            return Response({"message": [str(e)], "response_data": '', "is_success": False})
