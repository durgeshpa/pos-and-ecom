...
def create_order_data_excel(request, queryset, RetailerOrderedProduct, 
    ...
    return_reason_dict = dict(RetailerOrderedProduct.RETURN_REASON)
    # shops = dict(Shop.SHOP_TYPE_CHOICES)
    ...
    writer.writerow([
        ...
        'Product Type', 'Selling Price', 'Subtotal', 'Offer Discount', 'Reward Discount', 'Order Amount',
