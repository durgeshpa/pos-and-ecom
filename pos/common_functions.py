...
class OffersCls(object):
    ...
    @classmethod
    def rule_set_cart_mapping(cls, rule_id, coupon_type, coupon_name, coupon_code, shop, start_date, expiry_date, limit_of_usages_per_customer):
        """
        ...
        coupon = Coupon.objects.create(rule_id=rule_id, coupon_name=coupon_name, coupon_type=coupon_type,
                                       ...
                                       coupon_code=coupon_code, limit_of_usages_per_customer=limit_of_usages_per_customer,
                                       is_active=True)
        return coupon
