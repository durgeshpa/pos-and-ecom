...
class RetailerProductCls(object):
    ...
    @classmethod
    def create_retailer_product(cls, shop_id, sku, name, mrp, selling_price, linked_product_id, sku_type, description):
        RetailerProduct.objects.create(shop_id=shop_id, sku=sku, name=name, linked_product_id=linked_product_id,
