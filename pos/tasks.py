...
@task()
def order_loyalty_points(amount, user_id, tid, t_type_b, t_type_d, t_type_i, changed_by=None):
    """
    ...
    try:
        with transaction.atomic():
            ...
            # Buyer Rewards
            RewardCls.order_buyer_points(amount, user, tid, t_type_b, changed_by)
