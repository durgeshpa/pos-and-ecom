...
class OrderReport(APIView):
    ...
    def get_order_report(self, shop_id, start_date, end_date):
        ...
        order_details = {}
        i=0
        for products in OrderedProductMapping.objects.using('readonly').filter(ordered_product__order__seller_shop=seller_shop).select_related('ordered_product','ordered_product__order','ordered_product__order__seller_shop'):
