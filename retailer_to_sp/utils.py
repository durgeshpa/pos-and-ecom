...
def create_order_data_excel(request, queryset, OrderPayment, ShipmentPayment,
    ...
    writer.writerow([
        ...
        'Buyer Shop Name', 'Buyer Shop Type', 'Mobie No.(Buyer Shop)', 'City(Buyer Shop)',
    ...
    orders = queryset\
        ...
        .values('order_no', 'order_status', 'created_at', 'seller_shop_id',
                ...
                'buyer_shop__shop_name', 'buyer_shop__shop_type__shop_type','buyer_shop__shop_owner__phone_number',
