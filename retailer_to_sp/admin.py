...
class ExportCsvMixin:
    def export_as_csv(self, request, queryset):
        meta = self.model._meta
        list_display = ['order_no', 'shop_id','seller_shop', 'buyer_shop_with_mobile', 'pincode','city', 'total_final_amount',
...
class OrderAdmin(NumericFilterModelAdmin,admin.ModelAdmin,ExportCsvMixin):
    ...
    list_display = (
                    'order_no', 'download_pick_list','shop_id', 'seller_shop', 'buyer_shop_with_mobile',
