...
from pos.models import PaymentReconsile, PaymentRefund
import math
            ...
            if order_status == Order.CANCELLED:
                ...
                try:
                    ...
                    payment_datails = PaymentReconsile.objects.filter(tranjection_id=trxn_id,
                                                                      reconcile_status='payment_success').values(
                        'payment_id',
                        'amount').first()
                    if payment_datails:
                        ...
                        if response.get('status'):
                            obj = PaymentRefund.objects.create(trxn_id=trxn_id, payment_id=payment_id,
...
class OrderedItemCentralDashBoard(APIView):
    ...
    def get_pos_ecom_orders_details(self, shop):
        ...
        if total_refund_amount:
            total_ordered_final_amount -= total_refund_amount
        # POS Ordered Count
        ...
        if pos_total_refund_amount:
            pos_total_ordered_final_amount -= pos_total_refund_amount
        # ECOM Ordered Count
        ...
        if ecom_total_refund_amount:
            ecom_total_ordered_final_amount -= ecom_total_refund_amount
        ...
        if total_invoice_refund_amount:
            total_invoices_final_amount -= total_invoice_refund_amount
        # POS Invoice Count
        ...
        if pos_total_invoice_refund_amount:
            pos_total_invoices_final_amount -= pos_total_invoice_refund_amount
        # ECOM Invoice Count
        ...
        if ecom_total_invoice_refund_amount:
            ecom_total_invoices_final_amount -= ecom_total_invoice_refund_amount
