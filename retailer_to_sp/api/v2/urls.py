...
urlpatterns = [
    ...
    url(r'^download-return-shipment-barcode/(?P<pk>\d+)/$', DownloadReturnShipmentBarcode.as_view(), name='download_return_shipment_barcode')
]
