...
from .views import (
    ...
    BillingAddressAutocomplete, shipment_status, create_franchise_po, ShipmentMergedBarcode, SourceShopAutocomplete,ProductCategoryAutocomplete
)
urlpatterns = [
    ...
    url(r'^products-category-autocomplete/$', ProductCategoryAutocomplete.as_view(), name='products-category-autocomplete'),
    ...
    url(r'^source-shop-autocomplete/$', SourceShopAutocomplete.as_view(), name='source-shop-autocomplete'),
    ]
