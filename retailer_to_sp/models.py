...
class Feedback(models.Model):
    ...
    user = models.ForeignKey(get_user_model(), related_name='user_feedback',null=True, blank=True, on_delete=models.SET_NULL)
    shipment = models.ForeignKey(OrderedProduct, related_name='shipment_feedback', null=True, blank=True, on_delete=models.SET_NULL)
