...
from shops.api.v2.views import (ApprovalStatusListView, AddressListView, ShopDocumentTypeListView, ShopInvoiceStatusListView, ShopOwnerNameListView, ShopTypeListView, ShopTypeDetailView, ShopView)
...
urlpatterns = [
    ...
    url('shop-document-type-list/', ShopDocumentTypeListView.as_view(), name='shop-document-type-list'),
    url('shop-invoice-status-list/', ShopInvoiceStatusListView.as_view(), name='shop-invoice-status-list'),
