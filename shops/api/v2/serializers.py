...
class ShopCrudSerializers(serializers.ModelSerializer):
    ...
    approval_status_reason = ChoiceField(choices=Shop.APPROVAL_STATUS_REASON_CHOICES, required=False, allow_null=True)
    ...
    class Meta:
        ...
        fields = ('id', 'shop_name', 'shop_code', 'shop_code_bulk', 'shop_code_discounted', 'warehouse_code',
                  ...
                  'shop_name_documents', 'shop_log', 'pos_enabled', 'approval_status_reason')
