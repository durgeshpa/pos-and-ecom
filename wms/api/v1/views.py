...
class PickupDetail(APIView):
    ...
    def post(self, request):
        ...
        bin_inv = BinInventory.objects.filter(bin__bin_id=bin_id, quantity__gt=0).order_by(
        ...
        msg = {'is_success': True, 'message': 'pick up data added successfully', 'data': serializer.data}
        return Response(msg, status=status.HTTP_200_OK)
