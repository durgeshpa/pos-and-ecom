    ...
    def post(self, request):
        ...
        for i, value in diction.items():
            ...
            if sh.shop_type.shop_type == 'sp':
                ...
                # if such exntry exists, check the inventory already there in this bin, this includes items yet to be picked
                ...
                with transaction.atomic():
                    if bin_inventory.exists():
                        qs = bin_inventory.aggregate(available=Sum('quantity'), to_be_picked=Sum('to_be_picked_qty'))
