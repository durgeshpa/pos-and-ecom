...
class PickupDetail(APIView):
    ...
    def post(self, request):
        ...
        serializer = PickupSerializer(picking_details,many=True, fields=('id','batch_id_with_sku','product_mrp','quantity', 'pickup_quantity', 'sku_id', 'is_success'))
        msg = {'is_success': True, 'message': 'picking details', 'data': serializer.data,'pick_data':pick_data}
